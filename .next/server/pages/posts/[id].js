...
async function getStaticProps({ params  }) {
    const postData = await (0,_lib_posts__WEBPACK_IMPORTED_MODULE_2__/* .getPostData */ .AU)(params.id); //あとでasyncとawaitをつける。
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,469,400], () => (__webpack_exec__(9955)));
